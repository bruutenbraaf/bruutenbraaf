...
<footer>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8 justify-content-start justify-content-md-end d-flex">
                <div class="cnt">
                    <?php if (have_rows('contact_items', 'option')) : ?>
                        <?php while (have_rows('contact_items', 'option')) : the_row(); ?>
                            <?php $contact_item = get_sub_field('contact_item'); ?>
                            <?php if ($contact_item) { ?>
                                <a href="<?php echo $contact_item['url']; ?>" target="<?php echo $contact_item['target']; ?>"><?php echo $contact_item['title']; ?></a>
                            <?php } ?>
                        <?php endwhile; ?>
                    <?php endif; ?>
                </div>
